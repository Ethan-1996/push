  ...
  <el-table
    ...
    <el-table-column label="操作" width="110">
      <template slot-scope="scope">
        ...
        <el-link type="primary" @click="dialogFormVisible = true,remark(scope.row.id,scope.row.goods_add_remark)">备注</el-link><br/>
...
<script>
  import {editLower,editRemark,editDelete,getCoupon} from '@/api/api.js'
  export default {
      name:"List",
    ...
    methods: {
      ...
      remark(id,remark) {         //点击出现 可以新加备注的 form 
        if(remark != ''){      //这里是 点击 出现 一个对话框 如果 已经有备注的话 把备注 渲染到 对话框的输入框中 
