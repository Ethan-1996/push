<template>
    <div class="historyContent">
        ...
        <div class="goodsState">
            <div class="states">
                <el-link @click="getGoodsList(2,1,3,searchInfo)" :underline="false" :type="inlineType">当前在线商品</el-link>
                <el-link @click="getGoodsList(1,1,3,searchInfo)" :underline="false" :type="fuType">预告</el-link>
                <el-link @click="getGoodsList(4,1,3,searchInfo)" :underline="false" :type="noType">失效商品</el-link>
                <el-link @click="getGoodsList(3,1,3,searchInfo)" :underline="false" :type="endType">已结束</el-link>
            </div>
            <div class="search">
        ...
        <List :listInfo="listInfo" :info="info" type="3"/>
...
export default {
    ...
    methods:{
        search(){
            ...
            this.getGoodsList(type,1,3,this.searchInfo)
            this.pageShow = false
            this.$nextTick(()=> {
                this.pageShow = true
            })
        ...
        handleCurrentChange(val) {    //切换 页码的函数
            ...
            this.getGoodsList(type,val,3,this.searchInfo)
        }
    }
