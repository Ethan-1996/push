    ...
    <div class="historyContent">
        ...
        <div class="goodsState">
            <div class="states">
                ...
                <el-link @click="getGoodsList(4,1)" :underline="false" :type="noType">失效商品</el-link>
                <el-link @click="getGoodsList(3,1)" :underline="false" :type="endType">已结束</el-link>
            </div>
            <div class="search">
        ...
        <List :listInfo="listInfo" :info="info" type="0" :changeInfo="changeInfo"/>
